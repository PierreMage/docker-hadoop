...
[![DockerPulls](https://img.shields.io/docker/pulls/sequenceiq/hadoop-docker.svg)](https://registry.hub.docker.com/u/pierremage/hadoop/)
[![DockerStars](https://img.shields.io/docker/stars/sequenceiq/hadoop-docker.svg)](https://registry.hub.docker.com/u/pierremage/hadoop/)
...
```
docker build -t pierremage/hadoop:2.7.2 .
```
# Pull the image
...
```
docker pull pierremage/hadoop:2.7.2
```
...
```
docker run -it pierremage/hadoop:2.7.2 /etc/bootstrap.sh -bash
```
